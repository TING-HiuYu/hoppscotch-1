          ...
          children: [
            {
              ...
              expectResults: [
                ...
                // TODO: Fix negation bug - this should pass but currently fails
                // Issue: .not.be.above(10) when value is 5 (already < 10) incorrectly returns "fail"
                // This is a pre-existing bug in the negation logic for comparison operators
