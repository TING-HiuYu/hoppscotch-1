...
interface ChaiExpectation {
  ...
  // Type assertions
  a(type: string): ChaiExpectation
  an(type: string): ChaiExpectation
  ...
  // Length assertions
  length: ChaiExpectation
  lengthOf(n: number): ChaiExpectation
  ...
  // Key assertions
  keys(...keys: string[]): ChaiExpectation
  key(key: string): ChaiExpectation
...
declare namespace hopp {
  ...
  function expect(value: any): ChaiExpectation
  ...
  const request: Readonly<{
    readonly url: Readonly<{
      ...
      readonly query: Readonly<{
         ...
         */
        filter(callback: (param: { key: string; value: string }) => boolean): Array<{ key: string; value: string }>
        /**
    ...
    readonly headers: Readonly<{
       ...
       */
      filter(callback: (header: { key: string; value: string }) => boolean): Array<{ key: string; value: string }>
      /**
