<template>
  <div class="space-y-4">
    ...
    <!-- Script import checkbox - only shown if experimental scripting is enabled -->
    <div v-if="experimentalScriptingEnabled" class="ml-10 space-y-2">
      ...
      <!-- Description explaining version support and limitations -->
...
// Check if experimental scripting sandbox is enabled
const experimentalScriptingEnabled = useSetting(
  "EXPERIMENTAL_SCRIPTING_SANDBOX"
)

const emit = defineEmits<{
  (e: "importFromFile", content: string[], importScripts: boolean): void
}>()
